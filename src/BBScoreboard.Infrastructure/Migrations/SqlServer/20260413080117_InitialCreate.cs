        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerId = table.Column<int>(type: "int", nullable: false, defaultValue: -1),
                    ActionCode = table.Column<int>(type: "int", nullable: false),
                    Arg = table.Column<int>(type: "int", nullable: false),
                    RecPlayerId = table.Column<int>(type: "int", nullable: false, defaultValue: -1),
                    ActionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    GameTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TeamScore1 = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    TeamScore2 = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameId = table.Column<int>(type: "int", nullable: false),
                    Quarter = table.Column<int>(type: "int", nullable: false),
                    FGA3 = table.Column<int>(type: "int", nullable: false),
                    FGM3 = table.Column<int>(type: "int", nullable: false),
                    FTA = table.Column<int>(type: "int", nullable: false),
                    FTM = table.Column<int>(type: "int", nullable: false),
                    REBOFF = table.Column<int>(type: "int", nullable: false),
                    REBDEF = table.Column<int>(type: "int", nullable: false),
                    ...
                    FOULPER = table.Column<int>(type: "int", nullable: false),
                    FOULTECH = table.Column<int>(type: "int", nullable: false),
                    InFloor = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    TeamId = table.Column<int>(type: "int", nullable: false),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Venue = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ...
                    IsTimeOn = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    TimeLeft = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastActivityDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdateForRefresh = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    TeamColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
